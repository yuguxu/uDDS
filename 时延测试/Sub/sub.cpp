...
void UserDataTypeListener::on_data_available(DataReader* reader)
{
	...
	for (i = 0; i < data_seq.length(); ++i) {
            if (data_seq[i].sender_id == 0)signal = 0;
...
/* 发布者函数 */
extern "C" int publisher_main(int domainId, int sample_count, std::string randomString,int data_size)
{
