...
extern "C" int publisher_main(int domainId, int sample_count)
{
	...
	if (instance == NULL) {
		fprintf(stderr, "TestDataTypeTypeSupport::create_data error\n");
		publisher_shutdown(participant);
		return -1;
	}
...
//		strcpy(instance->color, "red");
	...
	if (retcode != RETCODE_OK) {
		fprintf(stderr, "TestDataTypeTypeSupport::delete_data error %d\n", retcode);
	}
